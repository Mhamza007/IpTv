...
import com.mhamza007.iptv.SeriesActivity
import kotlinx.android.synthetic.main.activity_dashboard_ser.*

class DashboardSerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dashboard_ser)
    ...
    private fun showLogoutDialog() {
        dialog = Dialog(this@DashboardSerActivity)
        ...
        exitYesBtn.setOnClickListener {
            dialog.dismiss()
            startActivity(Intent(this@DashboardSerActivity, MainActivity::class.java))
