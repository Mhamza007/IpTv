...
import com.mhamza007.iptv.SettingsActivity
import kotlinx.android.synthetic.main.activity_dashboard_set.*

class DashboardSetActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dashboard_set)
    ...
    private fun showLogoutDialog() {
        dialog = Dialog(this@DashboardSetActivity)
        ...
        exitYesBtn.setOnClickListener {
            dialog.dismiss()
            startActivity(Intent(this@DashboardSetActivity, MainActivity::class.java))
